...
<form id="Form1" runat="server"   >
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">新 增 回 診</h2>
    ...
    <div class="rwd" style=" margin-top: -160px;">
                    ...
                    <table class="j-table2" style="background-color:rgba(245,218,124,0.3);">
                     <tr>
                        <td class="tableTitleFont">診所名</td>
                        <td class="tableCFont">

                            <asp:TextBox ID="tbxClinic" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableTitleFont">診所地址</td>
                        <td class="tableCFont">
                            <asp:TextBox ID="tbxAddress" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tableCFont">
                           ...
                           <asp:TextBox ID="txtConDate" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black"
                    ...
                    <tr>
                        <td class="tableTitleFont">回診時間</td>
                        <td class="tableCFont">
                            
                           <asp:TextBox ID="tbTime" runat="server" Height="90%" Width="95%" Font-Size="150%"
                    ...
                    <tr>
                        ...
                        <td class="tableCFont">
                            <asp:TextBox ID="TextBox1" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableTitleFont">診號</td>
                        <td class="tableCFont">
                            <asp:TextBox ID="TextBox2" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                       <td class="tableTitleFont">被照護者姓名</td>
                        <td class="tableCFont">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" Height="90%" Width="95%" Font-Size="150%" ForeColor="Black">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" AutoPostBack="True" Font-Size="X-Large" Font-Names="微軟正黑體">
                      ...
                      <tr>
                       <td colspan="2" class="tableCFont"> 
                         <asp:Button ID="btnOK" CssClass="hospitalButton1" runat="server" OnClick="btnOK_Click" Font-Bold="True" Font-Names="微軟正黑體"  Font-Size="Medium"  Height="40px" Width="80px" Text="新增"  />

                        <asp:Button ID="btnCancel" CssClass="hospitalButton1" runat="server" OnClick="btnCancel_Click" Font-Bold="True" Font-Names="微軟正黑體"  Font-Size="Medium"  Height="40px" Width="80px" Text="取消"  />

                        <asp:Button ID="btnBack" CssClass="hospitalButton1" runat="server" OnClick="btnBack_Click" Font-Bold="True" Font-Names="微軟正黑體"  Font-Size="Medium"  Height="40px" Width="100px" Text="返回資料頁"  />
