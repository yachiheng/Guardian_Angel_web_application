<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consolution.aspx.cs" Inherits="GuardianAngel.Consolution" %>
...
<body >
  <!-- Navigation導覽列 -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">回 診 資 料</h2>
    ...
    <div class="rwd"  style=" margin-top: -140px;">
    ...
    <!--主頁內容-->
        ...
        <tr  >
            <td class="text-center">&nbsp;
                 <asp:GridView CssClass="j-table2"   ID="GridView1" runat="server" AllowPaging="True" CaptionAlign="Bottom" HorizontalAlign="Center" BorderColor="White"
                  Width="90%" Height ="95%"  ViewStateMode="Enabled" DefaultCellStyle="true" HeaderText="修改" ItemStyle-HorizontalAlign="Center"  OnRowCommand="GridView1_RowCommand" PageIndexChanging="GridView1_PageIndexChanging" RowDataBound="GridView1_RowDataBound" BackColor="#FFF0F0" >

                     <Columns>
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandName="" Text="詳細" ForeColor="#d78304"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <br />
                <asp:Button ID="btnAdd" CssClass="hospitalButton1" runat="server"  Font-Bold="True" Font-Names="微軟正黑體"  Font-Size="Medium"  Height="40px" Width="80px" Text="新增" PostBackUrl="ConsulationAdd.aspx" />
                <br />
