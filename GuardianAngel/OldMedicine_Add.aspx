           ...
           <table class="j-table"> 
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="tableCFont">   
                                <asp:TextBox ID="tbNname" autocomplete="off" runat="server" Width="100%"
                                    placeholder="格式範例：感冒用藥"></asp:TextBox>
                         </td>
                    </tr>
                     <tr>
                        <td class="tableTitleFont">用藥時間設定</td>
                        <td class="tableCFont">
                            <div class="input-group clockpicker">
                                <asp:TextBox ID="txtTime1"  autocomplete="off" class="form-control" runat="server" CssClass="auto-style1" Width="100%"></asp:TextBox>
                                   
                            </div>

                            <div class="input-group clockpicker" style="margin-top: 0px; left: 0px; top: 0px;">
                                 <asp:TextBox ID="txtTime2"  autocomplete="off" class="form-control" runat="server" CssClass="auto-style1" Width="100%"></asp:TextBox>
                                   
                            </div>

                            <div class="input-group clockpicker">
                                 <asp:TextBox ID="txtTime3"  autocomplete="off" class="form-control" runat="server" CssClass="auto-style1" Width="100%"></asp:TextBox>
                               
                            </div>

                            <div class="input-group clockpicker">
                                 <asp:TextBox ID="txtTime4"  autocomplete="off" class="form-control" runat="server" CssClass="auto-style1" Width="100%"></asp:TextBox>
                               
                            </div>

                            <div class="input-group clockpicker">
                                 <asp:TextBox ID="txtTime5" autocomplete="off" class="form-control" runat="server" CssClass="auto-style1" Width="100%"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="tableCFont">
                            <asp:TextBox ID="txtStartDate" autocomplete="off" runat="server" Width ="100%"
                             placeholder="格式範例：2019/02/22"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableTitleFont">結束日期</td>
                        <td class="tableCFont">
                            <asp:TextBox ID="txtEndDate" autocomplete="off" runat="server" Width ="100%"
                                placeholder="格式範例：2019/02/22"></asp:TextBox>
                        </td>
                    </tr>
                   <tr>
